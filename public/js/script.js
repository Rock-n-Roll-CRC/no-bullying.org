...
document.addEventListener("click", (e) => {
    ...
    if (eTarget !== null) {
        ...
        if (!isDropdownButton && eTarget.closest(".language-menu") !== null)
            return;
        if (isDropdownButton) {
...
if (tabs !== null && tabContents !== null) {
    tabs.forEach((tab) => {
        tab.addEventListener("click", () => {
            ...
            const currentTabContent = document.querySelector(".tab-content--selected");
    ...
    buttons.forEach((button) => {
        button.addEventListener("click", () => {
            ...
            if (quotes !== null && quotes !== undefined) {
                ...
                const selectedIndicator = document.querySelector(".carousel__indicator--selected");
                if (selectedQuote !== null) {
                    let newIndex = [...quotes.children].indexOf(selectedQuote) + offset;
                    if (newIndex < 0)
                        newIndex = quotes.children.length - 1;
                    if (newIndex >= quotes.children.length)
                        newIndex = 0;
...
nextButton?.addEventListener("click", () => {
    ...
    const selectedAnswer = document.querySelector(".answer__button--selected");
    const nextQuestion = document.querySelector(".question--selected + .question");
    const lis = [
        ...document.querySelectorAll(".question--selected > .question__answers-list .answer"),
    ];
    lis.forEach((li) => {
        ...
        const studentsViolanceDescription = document.querySelector(".students-violance__description");
        const studentsViolanceIcon = document.querySelector(".students-violance__icon");
        const teachersViolanceDescription = document.querySelector(".teachers-violance__description");
        const teachersViolanceIcon = document.querySelector(".teachers-violance__icon");
        ...
        if (selectedQuestion === lastQuestion && selectedAnswer !== null) {
            ...
            if (studentsViolanceDescription !== null &&
